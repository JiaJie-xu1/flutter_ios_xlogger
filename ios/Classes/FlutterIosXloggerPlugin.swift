...
public class FlutterIosXloggerPlugin: NSObject, FlutterPlugin {
    var bridge = XLogBridge();
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "flutter_ios_xlogger", binaryMessenger: registrar.messenger())
    let instance = FlutterIosXloggerPlugin()
